<?php
if (!isset($_GET['pid']) || empty($_GET['pid']) || get_post_status(base64_decode($_GET['pid'])) === FALSE) {
  dokan_get_template_part('global/dokan-error', '', array( 'deleted' => false, 'message' => __( 'You have no permission to view orders page', 'dokan' ) ) );
  return;
} 
...
<?php do_action( 'dokan_dashboard_wrap_start' ); ?>
    ...
    <div class="dokan-dashboard-wrap" id="dashboard_main1">
        ...
        ?>
        <section class="order-download order-full">
          <div class="container">
            <div class="row"> 
              <div class="col-md-4">
                     ...
                     <li>
                      <form action="" method="POST"> 
                       ...
                       <select name="order_download_list"  class="form-control deal-order-download">
                        <option value="">Fulfillment Downloads</option>
                        <option title="Order summary of all product sold" value="download_summary">Pick List</option>
                        <option title="All information needed to fulfill orders" value="order_fulfillment">Order List</option>
                        <option title="Shipping label information" value="order_shipping">Shipping  List</option>
                      </select>
                      </form>
                     </li>
                     <li>
                        <button type="button" class="btn btn-primary upload-tracking">Upload tracking</button>
                     </li>
                     <li>
                        <form action="" id="frm_order_search" method="GET">   
                            <input type="hidden" name="pid" value="<?php echo $_GET['pid']; ?>">                         
                            <input type="text" class="order_search" value="<?php echo !empty($order_search)?$order_search:''; ?>" name="order_search" class="form-control" placeholder="Order Search">
                            <span><i class="fa fa-search" aria-hidden="true"></i></span>
                        </form>
                     </li>
                   </ul>
                </div>
              </div><?php //var_dump($user_orders); ?>
              <div class="col-md-12">
