			...
			<div class="right_menu">
				<div class="cart_sign">
					<?php if(is_user_logged_in()){ 
						...
						{
							echo '<a class="my-account-menu-nav" href="'.site_url('/dashboard').'">My Account</a>'; 
						}else{
							echo '<a class="my-account-menu-nav" href="'.site_url('/my-account').'">My Account</a>'; 
						}
					}else{
						echo '<a class="my-account-menu-nav" href="'.site_url('/my-account').'">Sign In</a>';
					} 
					global $woocommerce;
					$items = $woocommerce->cart->cart_contents_count;
					?>
				<a href="<?php echo site_url(); ?>/wishlist/" class="wishlisthome"><span></span></a>
				<a href="<?php echo site_url(); ?>/cart/" class="mini_cart_data">
					<img src="<?php echo site_url(); ?>/wp-content/themes/divi-child/fpcustomization/images/cartimgnew1.png">
					<?php if(!empty($items)){ echo '<span id="mini-cart-count" class="cart-items">'.$items.'</span'; } ?>
				</a> 
				</div>  
				<div class="rignt_menu_btn">
					<a class="right_menu_toggle" href="#"><strong>&#9776;</strong></a>
					<div class="toggle_right_menu">
						<a class="right_menu_hide" href="#"><span>&#10006;</span></a>
						<nav id="top-menu-nav">
							<?php
							$toggle_nav = wp_nav_menu( array('theme_location' => 'toggle-menu', 'menu_id' =>'Toggle Menu', 'container' => '', 'fallback_cb' => '', 'menu_class' => $menuClass, 'echo' => false ) );   
							echo et_core_esc_wp( $toggle_nav );      
							?>
						</nav> 
					</div>
				</div>
			...
			<div class="bottom_header">
				<div class="container">
					...
					<div class="left_menu">
						<nav id="top-menu-nav">
							<?php
								 $secondaryNav = wp_nav_menu( array( 'menu_id' => 'top-menu', 'container' => '', 'fallback_cb' => '', 'menu_class' => $menuClass, 'echo' => false ) ); 
