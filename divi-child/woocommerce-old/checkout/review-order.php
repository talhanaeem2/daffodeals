...
$_SESSION['shipping_price'] = 0;
?>
<table class="shop_table woocommerce-checkout-review-order-table">
	<thead>
		<tr>
			<th class="product-name"><?php _e( 'Product', 'woocommerce' ); ?></th>
			<th class="product-name"><?php _e( 'Shipping', 'woocommerce' ); ?></th>
			...
			foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
				...
				if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_checkout_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
					...
					<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
						...
						<td class="product-shipping" data-title="<?php esc_attr_e( 'Shipping', 'woocommerce' ); ?>">
							<?php
								...
								$_SESSION['shipping_price'] = isset($_SESSION['shipping_price'])?$_SESSION['shipping_price']+$shipping:$shipping;
								echo wc_price($shipping_price);
							?>
						</td>
	...
	<tfoot>
		...
		<tr class="cart-shipping">
			...
			<td><?php echo wc_price($_SESSION['shipping_price']); ?></td>
		</tr>
